...
- Solid State Physics (theoretical):  Developed molecular dynamic simulations using Leonard Jones and Monte Carlo models. Additionally, worked on models and werifying accuracies of perturbed systems of a 2D n x n array skewed lattice crystalline structure.
